        ...
        <ul class="space-y-1">
            ...
            <li>
                ...
                <ul class="submenu pl-9 hidden space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.facturacion.index') }}" class="block p-2 rounded hover:bg-gray-800 text-sm">
                            <i class="fas fa-search mr-2"></i>Consultar
                        </a>
                    </li>
                    <li>
                            {{-- Añado la ruta --}}
                        <a href="{{ route('admin.facturacion.create') }}" class="block p-2 rounded hover:bg-gray-800 text-sm">
             ...
             <li>
                ...
                <ul class="submenu pl-9 hidden space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.staff.index') }}" class="block p-2 rounded hover:bg-gray-800 text-sm">
                            <i class="fas fa-search mr-2"></i>Consultar
                        </a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="submenu pl-9 hidden space-y-1">
                    <li>
                        <a href="{{ route('admin.usertype.index') }}" class="block p-2 rounded hover:bg-gray-800 text-sm">
                            <i class="fas fa-search mr-2"></i>Consultar
                        </a>
                    </li>
                    <li>
                    
                        <a href="{{ route('admin.usertype.create') }}" class="block p-2 rounded hover:bg-gray-800 text-sm">
                            <i class="fas fa-plus-circle mr-2"></i>Nuevo
                        </a>
                    </li>
                </ul>
