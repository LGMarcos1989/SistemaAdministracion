...
@section('title', 'Nuevo Tipo Impositivo | Sistema')

@section('section')
    <div class="container mx-auto px-4 py-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Nuevo Tipo Impositivo</h1>
            <p class="text-gray-600 mt-2">Complete el formulario para registrar un nuevo impuesto</p>
        </div>
            ...
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li class="flex items-center">
                    ...
                    <a href="{{ route('admin.impuestos.index') }}"
                        class="ml-2 text-blue-600 hover:text-blue-800">Tipo Impositivo</a>
                </li>
                <li class="flex items-center">
                    <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
                    <span class="ml-2 text-gray-500">Nuevo Tipo Impositivo</span>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">
                    <i class="fas fa-user-plus text-blue-500 mr-2"></i> Información del Tipo Impositivo
                </h2>
            </div>
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                            <div>
                                <a href="{{ route('admin.impuestos.index') }}"
                                    ...
                                    <i class="fas fa-arrow-left mr-2"></i>Volver a la lista de Tipos Impositivos
                                </a>
                            </div>
