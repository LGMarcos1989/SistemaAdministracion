...
@section('title', 'Actualizar Tipo Impositivo | Sistema')

@section('section')
    <div class="container mx-auto px-4 py-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Actualizar Tipo Impositivo</h1>
            <p class="text-gray-600 mt-2">Editar un tipo impuesto</p>
        </div>
