                    ...
                    <div class="p-6">
                        <div class="space-y-3">
                            <div class="flex justify-between py-2 border-b border-gray-100">
                                ...
                                <span
                                    class="font-medium text-gray-900">{{ getMoney($facturacion->tax_base) }}</span>
                            </div>
                            ...
                            @if ($facturacion->type_rate_id)
                                <div class="flex justify-between py-2 border-b border-gray-100">
                                    ...
                                    <span class="font-medium text-gray-900">
                                        {{ $facturacion->type_rate->name ?? 'N/A' }} ->
                                        {{ $facturacion->type_rate->value ?? 'N/A' }}%
                                       
                                    </span>
                                </div>

                                <div class="flex justify-between py-2 border-b border-gray-100">
                                    <span class="text-gray-600">Total Impuesto:</span>
                                    <span class="font-medium text-gray-900">
                    ...
                    <div class="p-6">
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                <span class="text-gray-600">Base Imponible:</span>
                                <span class="font-medium">{{ getMoney($facturacion->tax_base) }}</span>
                            </div>
                            @if ($facturacion->type_rate_id)
                                <div class="flex justify-between">
