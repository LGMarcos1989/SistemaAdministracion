...
@section('section')
    ...
    <div class="container mx-auto px-4 py-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Actualizar Factura</h1>
            <p class="text-gray-600 mt-2">Complete el formulario para actualización de factura</p>
        </div>
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li class="flex items-center">
                    <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
                    <span class="ml-2 text-gray-500">Actualizar Factura</span>
                </li>
            </ol>
        </nav>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="client_id" class="block text-sm font-medium text-gray-700 mb-2">
                                 ...
                                 <input type="text" id="client_id" name="client_id" disabled  value="{{ old('client_id',$facturacion->client->bussiness_name) }}"
                                            class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg bg-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="datetime" id="invoice_date" name="invoice_date"  value="{{ old('invoice_date',$facturacion->invoice_date) }}"
                                            class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 bg-gray-300 focus:ring-blue-500 focus:border-transparent"
                                            >
                                    </div>
                                    @error('invoice_date')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="invoice_number" name="invoice_number" value="{{ old('invoice_number',$facturacion->invoice_number) }}"
                                            class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 bg-gray-300 focus:ring-blue-500 focus:border-transparent"
                            ...
                            <div class="grid grid-cols-4  gap-6">
                                <div class="col-span-3">
                                    ...
                                    <div class="relative">
                                        ...
                                        <textarea id="description" name="description" 
                                            class="w-full pl-10 pr-4 py-2 border border-gray-300 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            placeholder="Alquiler de instalaciones">{{ $facturacion->description}}</textarea>
                                    </div>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" step="0.01" id="tax_base" name="tax_base" value="{{ old('tax_base',$facturacion->tax_base) }}"
                                            class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg bg-gray-300 focus:outline-none focus:ring-2 bg-gray-300 focus:ring-blue-500 focus:border-transparent"
                                            placeholder="1000">
                                    </div>
                                    @error('tax_base')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                         ...
                                         <input type="tax_rate_id"  id="tax_rate_id" name="tax_base" value="{{ old('tax_base',$facturacion->tax_base) }}"
                                            class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg bg-gray-300 focus:outline-none focus:ring-2 bg-gray-300 focus:ring-blue-500 focus:border-transparent"
                                            placeholder="1000">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" step="0.01" id="total" name="total" value="{{ old('total',$facturacion->total) }}"
                                            class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 bg-gray-300 focus:ring-blue-500 focus:border-transparent"
                                            placeholder="1270">
                                    </div>
                                    @error('total')
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="status" name="status" 
                                           ...
                                           >
                                          <option selected value="{{$facturacion->status}}">{{$facturacion->status}}</option>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <textarea type="number" step="0.01" id="nota" name="nota" value="{{ old('nota' ) }}"
                                            class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            placeholder="Ponga las observaciones que crea necesarias si cambia de estado o algun hecho relevante">{{ $facturacion->nota }}</textarea>
                                    </div>
                                    @error('total')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
