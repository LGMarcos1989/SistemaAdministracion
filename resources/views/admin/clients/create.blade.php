...
@section('title', 'Nuevo Cliente | Sistema')

@section('section')
    <div class="container mx-auto px-4 py-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Nuevo Cliente</h1>
            <p class="text-gray-600 mt-2">Complete el formulario para registrar un nuevo cliente</p>
        </div>
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li class="flex items-center">
                    <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
                    <span class="ml-2 text-gray-500">Nuevo Cliente</span>
                </li>
            </ol>
        </nav>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="bussiness_name" name="bussiness_name" value="{{ old('bussiness_name') }}"
                                    ...
                                    placeholder="Ej: Empresa S.L." required>
