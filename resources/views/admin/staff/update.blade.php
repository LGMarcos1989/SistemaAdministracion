                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" id="fullname" name="fullname" value="{{ old('fullname', $staff->fullname) }}"
                            ...
                            <div>
                                ...
                                <input type="text" id="dni" name="dni" value="{{ old('dni', $staff->dni) }}"
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="city" name="city" value="{{ old('city', $staff->city) }}"
  ...
  <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="password" id="password" name="password" value="{{ old('password', $staff->user->password) }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                     required>
                                @error('password')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
