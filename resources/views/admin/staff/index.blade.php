    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Equipo Staff</h1>
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li class="flex items-center">
                    ...
                    <span class="ml-2 text-gray-500">Usuarios</span>
                </li>
            </ol>
        </nav>
                ...
                <form action="{{ route('admin.staff.index') }}" method="GET"
                    ...
                    <div>
                        <select name="status"
                            ...
                            <option value="inactivo" {{ request('inactivo') == 'inactivo' ? 'selected' : '' }}>Inactivo</option>
                        </select>
                    </div>
                        ...
                        @forelse ($person as $p)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="text-sm text-gray-900 font-medium">#{{ $p->id }}</span>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-bold {{ $p->isActive ? 'text-green-600':'text-red-600'}}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('admin.staff.edit', $p) }}"
                                            class="text-blue-600 hover:text-blue-900" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        <a href="{{ route('admin.staff.show', $p) }}"
                                            class="text-green-600 hover:text-green-900" title="Ver detalles">
                                            <i class="fas fa-eye"></i>
                                        </a>

                                        <form action="{{ route('admin.staff.destroy', $p) }}" method="POST"
                                            class="inline"
        ...
        <div class="mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                <!-- Total Usuarios -->
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:row-span-2">
                    <div class="flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <!-- Usuarios Administradores -->
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{ $administradoresCount ?? 0 }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-12 w-12 bg-red-100 rounded-lg flex items-center justify-center">
                            <i class="fa-solid fa-magnifying-glass-chart text-yellow-600"></i>
                        </div>
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">Consultores</p>
                            <p class="text-2xl font-semibold text-gray-900">{{ $consultoresCount ?? 0 }}</p>
                        </div>
                    </div>
                </div>  
            </div>
